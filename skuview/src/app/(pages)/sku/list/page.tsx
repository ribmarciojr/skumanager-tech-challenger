...
const onlyViewAllowed = ["Active", "Disabled", "Canceled"];
    ...
    <div>
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          <Button
            variant="contained"
            sx={{ backgroundColor: "#93DA49", color: "white" }}
            onClick={() => router.push("/sku/register")}
          >
            Cadastrar
          </Button>
        </Box>
      ...
      <Box>
        {data && (
          <SkuTable
            data={data.data.map((sku) => ({
              ...sku,
              descricao: useShortText(sku.descricao),
              status: SkuStatusMapper.mapToLabel(
                SkuStatusMapper.mapToEnum(filterStatus),
              ),
            }))}
            ...
            onEdit={
              !onlyViewAllowed.includes(filterStatus)
                ? handleSkuEdit
                : undefined
            }
            onView={
              onlyViewAllowed.includes(filterStatus) ? handleSkuEdit : undefined
            }
